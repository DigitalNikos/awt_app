...
import 'package:vienna_airport_taxi/presentation/screens/booking/from_airport/step1_screen.dart';
import 'package:vienna_airport_taxi/presentation/screens/booking/from_airport/step2_screen.dart';
import 'package:vienna_airport_taxi/presentation/screens/booking/from_airport/step3_screen.dart';
import 'package:vienna_airport_taxi/presentation/widgets/bottom_navbar.dart';

class FromAirportScreen extends StatelessWidget {
  const FromAirportScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => FromAirportFormProvider(),
      child: const _FromAirportScreenContent(),
    );
  }
}

class _FromAirportScreenContent extends StatelessWidget {
  const _FromAirportScreenContent();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        titleSpacing: 0,
        title: Text(
          localizations.translate('from_airport') ?? 'Vom Flughafen',
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: SvgPicture.asset(
                    'assets/images/hero_section/from-airport.svg',
                    width: 40,
                    height: 40,
                  ),
                ),
      ...
      body: Consumer<FromAirportFormProvider>(
